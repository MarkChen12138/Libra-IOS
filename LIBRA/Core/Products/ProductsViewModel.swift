...
final class ProductsViewModel: ObservableObject {
    ...
    func getProducts() {
        Task {
            let (newProducts, lastDocument) = try await ProductsManager.shared.getAllProducts(forCategory: selectedCategory?.categoryKey, count: 10, lastDocument: lastDocument)
