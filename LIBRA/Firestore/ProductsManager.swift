...
//    }
//
    func getAllProductsForCategory(category: String) async throws -> [Product] {// i removed private here
        try await productsCollection
...
//    }
//    
    func getAllProducts(forCategory category: String?, count: Int, lastDocument: DocumentSnapshot?) async throws -> (products: [Product], lastDocument: DocumentSnapshot?) {
