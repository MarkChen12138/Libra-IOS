...
struct DBUser: Codable {
    ...
    init(
        ...
        self.userId = userId
        self.isAuthencated = isAuthencated
        self.email = email
    ...
    enum CodingKeys: String, CodingKey {
        case userId = "user_id"
        case isAuthencated = "is_authencated"
        case email = "email"
    ...
    init(from decoder: Decoder) throws {
        ...
        self.isAuthencated = try container.decodeIfPresent(Bool.self, forKey: .isAuthencated)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.isAuthencated, forKey: .isAuthencated)
...
final class UserManager {
    ...
    private func userContractsCollection(userId: String) -> CollectionReference {
        userDocument(userId: userId).collection("Contracts")
    }
    
    private func userContractDocument(userId: String, ContractId: String) -> DocumentReference {
        userContractsCollection(userId: userId).document(ContractId)
    }
...
//            "user_id" : auth.uid,
//            "is_anonymous" : auth.isAuthencated,
...
//        }
//
//        let isAuthencated = data["is_anonymous"] as? Bool
//        let email = data["email"] as? String
//        let photoUrl = data["photo_url"] as? String
//        let dateCreated = data["date_created"] as? Date
//
//        return DBUser(userId: userId, isAuthencated: isAuthencated, email: email, photoUrl: photoUrl, dateCreated: dateCreated)
//    }
...
//    }
//    
    func addCompany(userId: String, company: Company) async throws {
        guard let data = try? encoder.encode(company) else {
            throw URLError(.badURL)
        }
        
        let dict: [String:Any] = [
            DBUser.CodingKeys.company.rawValue : data
        ]

        try await userDocument(userId: userId).updateData(dict)
    }
    
    func removeCompany(userId: String) async throws {
        let data: [String:Any?] = [
            DBUser.CodingKeys.company.rawValue : nil
        ]
